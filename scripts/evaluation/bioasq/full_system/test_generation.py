"""
BioASQ test generation evaluation entrypoint for FULL SYSTEM.

Outputs:
    results/eval_results/bioasq/full_system/detail.jsonl
    results/eval_results/bioasq/full_system/summary.json
    results/eval_results/bioasq/full_system/predictions.jsonl
"""
...
OUTPUT_DIR = project_root / "results" / "test_results" / "bioasq" / "full_system" / "generation"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate the BioASQ FULL SYSTEM on the test split."
    )
