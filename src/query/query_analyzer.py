...
class QueryAnalyzer(IQueryAnalyzer):
    ...
    async def analyze(self, query: str, history: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "- \"no_rag_needed\": Use this intent if the user is just making small talk (e.g. \"hello\", \"thank you\"), "
            "or if the question can be fully and directly answered using ONLY the provided conversation history without needing external medical retrieval.\n\n"
