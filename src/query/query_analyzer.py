...
class QueryAnalyzer(IQueryAnalyzer):
    ...
    async def analyze(self, query: str, history: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "- \"no_rag_needed\": Use this intent if the user is making small talk (e.g. \"hello\", \"thank you\"), "
            "if the question is ENTIRELY OUTSIDE the medical/health domain (e.g. asking about cats, weather, programming,...), "
            "or if the question can be fully answered using ONLY the provided conversation history without needing external medical retrieval.\n\n"
